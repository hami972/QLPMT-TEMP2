                    ...
                    <div className="row">
                        <div className="row ms-0 me-0" style={{ fontWeight: "500" }}>
                            ...
                            <div className="text-end">
                                <button type="submit" className="btn pb-2 pt-2 mt-2" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={onSearch}>
                                    Tìm kiếm
                                </button>
                                <button type="submit" className="btn pb-2 pt-2 mt-2 ms-3" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={() => { setErrors(""); setPatientModalOpen(true) }}>
                                    Thêm bệnh nhân
                                </button>
                            </div>
                        </div>
                    ...
                    <div className='pe-2 ps-2'>
                        ...
                        <div className="row mt-2">
                            <div className="row" style={{ fontWeight: "500" }}>
                                ...
                                <div className="text-end">
                                    <button type="submit" className="btn pb-2 pt-2 mt-2" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={onSearch1}>
                                        Tìm kiếm
                                    </button>
                                    <button type="submit" className="btn pb-2 pt-2 mt-2 ms-3" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={() => createNewRecord()}>
                                        Thêm
                                    </button>
                                </div>
                            </div>
                ...
                {(page === 3) ?
                    <div className='pe-2 ps-2'>
                        ...
                        {(cthsdt?.edit !== true || state == "create") && <div className="text-end">
                            <button type="submit" className="btn pb-2 pt-2 ps-3 mt-2 pe-3" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={() => setServiceModalOpen(true)}>
                                Thêm dịch vụ
                            </button>
                            <button type="submit" className="btn pb-2 pt-2 ps-3 mt-2 pe-3 ms-3" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={() => setMedicineModalOpen(true)}>
                                Thêm thuốc
                            </button>
                        </div>}
                        <table className="table" >
                        ...
                        {(cthsdt.edit != true || state == "create") && <div className="text-end">
                            <button type="submit" className="btn pb-2 pt-2 mt-3 mb-3" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={saveCTHSDT}>
                                Lưu
                            </button>
                        </div>}
                    </div>
