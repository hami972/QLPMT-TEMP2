                ...
                <div className="col-sm-6 col-md-5 col-lg-4 pe-2 ps-2">
                    <div style={{ backgroundColor: '#fff', border: "2px solid grey", borderRadius: "5px", boxShadow: "3px 3px #888888", marginTop: "70px" }} align="center">
                        <form>
                            ...
                            <NavLink to="/sign_in" className="btn d-flex justify-content-center col-10 mb-2 mt-2" style={{ color: "#01D09E" }}>Đăng nhập nếu bạn đã có tài khoản</NavLink>
                            {errors && <div className="error">{errors}</div>}
                            <button type="submit" className="btn col-10 pb-3 pt-3 mb-5" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={(e) => { handleSignup(e) }}>Đăng ký</button>
