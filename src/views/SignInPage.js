    ...
    return (
        <div>
            ...
            <section className="row g-0 backgroundMenu pb-5">
                <div className="col-sm-5 col-md-6 col-lg-7 d-none d-sm-block"><img alt="" src="/images/2.png" style={{ width: "90%" }} /></div>
                <div className="col-sm-6 col-md-5 col-lg-4 pe-2 ps-2">
                    <div style={{ backgroundColor: '#fff', border: "2px solid grey", borderRadius: "5px", boxShadow: "3px 3px #888888", marginTop: "70px" }} align="center">
                        <form>
                            ...
                            <NavLink to="/sign_up" className="btn d-flex justify-content-center col-10 mb-2 mt-2" style={{ color: "#01D09E" }}>Nếu bạn chưa có tài khoản, đăng ký ngay!</NavLink>

                            {<button type="submit" className="btn col-10 pb-3 pt-3" style={{ backgroundColor: "#01D09E", color: "#FFFFFF", marginBottom: "300px" }} onClick={handleSignin}>Đăng nhập</button>}
                        </form>
                    </div>
                </div>
                <div className='col-1'></div>
            </section >
            <section className="mt-5" style={{ backgroundColor: "#8DE4CF" }}>
                <div className="container">
                    <div className="row g-0">
                        ...
                        <div className="col-md-6 pt-5 pb-5">
                            <p style={{ fontSize: "36px" }}>Phòng khám Brilliance</p>
