            ...
            >
              ...
              <div className="p-3">
                <div
                  className="mb-3 p-2"
                  style={{
                    backgroundColor: item.Sang ? "#bfbfbf" : "#01D09E",
                    borderRadius: "10px",
                  }}
                >
                  Sáng
                ...
                <div
                  className="mb-3 p-2"
                  style={{
                    backgroundColor: item.Chieu ? "#bfbfbf" : "#01D09E",
                    borderRadius: "10px",
                  }}
                >
                  Chiều
                ...
                <div
                  className="mb-3 p-2"
                  style={{
                    backgroundColor: item.Toi ? "#bfbfbf" : "#01D09E",
                    borderRadius: "10px",
                  }}
                >
                  Tối
      ...
      {selectedMonth === "next" && (
        <div className="text-end">
          <button
            ...
            style={{ color: "#01D09E", border: "1px solid #01D09E" }}
            onClick={onDefault}
          >
            Mặc định
          </button>
