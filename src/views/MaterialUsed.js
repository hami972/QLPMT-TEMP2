        ...
        <div>
            <div className="row">
                ...
                <div className="text-end">
                    <button type="submit" className="btn pb-2 pt-2 mt-3 me-2" style={{ backgroundColor: "#01D09E", color: "#FFFFFF" }} onClick={onSearch}>
                        Tìm kiếm
                    </button>
                    <button type="submit" className="btn pb-2 pt-2 mt-3" style={{ backgroundColor: "#01D09EF", color: "#FFFFFF" }} onClick={() => setModalOpen(true)}>
                        Thêm
                    </button>
                </div>
            </div>
